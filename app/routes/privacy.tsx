    ...
    <main className="container mx-auto max-w-4xl flex-1 px-4 py-8">
      ...
      <div className="space-y-6 text-muted-foreground">
        ...
        <section>
          ...
          <p>
            Currently, Dashboard.Gold does not require user accounts or personal information. We do
            not collect names, email addresses, or other personally identifiable information unless
        ...
        <section>
          <h2 className="mb-3 text-2xl font-semibold text-foreground">4. Analytics and Tracking</h2>
        ...
        <section>
          ...
          <ul className="mt-2 ml-6 list-disc space-y-1">
            ...
            <li>We recommend reviewing their privacy policies before providing any information</li>
          </ul>
